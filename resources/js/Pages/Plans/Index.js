...
const Index = () => {
  ...
  return (
    <div>
      <h1 className="mb-8 text-3xl font-bold">Plans</h1>
      ...
      <div className="overflow-x-auto bg-white rounded shadow">
        <table className="w-full whitespace-nowrap">
          ...
          <tbody>
            {data.map(({ id, name, price, status, deleted_at }) => (
              <tr
                key={id}
...
Index.layout = page => <Layout title="Plans" children={page} />;
