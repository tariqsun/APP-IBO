...
const Edit = () => {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    put(route('organizations.update', organization.data.id));
  }
  ...
  function restore() {
    if (confirm('Are you sure you want to restore this organization?')) {
      Inertia.put(route('organizations.restore', organization.data.id));
    }
  }
    ...
    <div>
      ...
      <div className="mt-6 overflow-x-auto bg-white rounded shadow">
        <table className="w-full whitespace-nowrap">
          ...
          <tbody>
            {organization.data.contacts.map(
            ...
            {organization.data.contacts.length === 0 && (
              <tr>
